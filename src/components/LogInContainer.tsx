...
const LogInContainer:React.FC<{children:React.ReactNode}> = ({children}):JSX.Element => {
    ...
    return(
        ...
        <Paper elevation={2} sx={{
            ...
            <h5>Usuario: parishdavid101</h5>
            <h5>Contraseña: pH83@as</h5>
        </Paper>
    );
